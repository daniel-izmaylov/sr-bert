...
def main():
    ...
    parser.add_argument("--lexicon", default=1, type=int, help="Train the base model or not")
    parser.add_argument("--with_feature", default=1, type=int, help="Train the base model or not")
    ...
    parser.add_argument("--Wighted_loss", default=1, type=int, help="Train the base model or not")
    parser.add_argument("--IMSR", default=0, type=int, help="Train the base model or not")
    parser.add_argument("--number_labels", default=2, type=int, help="Train the base model or not")
    ...
    parser.add_argument("--version", default="4", type=str, help="Linear warmup over warmup_steps.")
    # parser.add_argument("--version_load", default="pretrain/7_10_epoch_long", type=str, help="Linear warmup over warmup_steps.")
    parser.add_argument("--version_load", default="pretrain/SSK_4.5", type=str, help="Linear warmup over warmup_steps.")
    parser.add_argument("--reload_from", default=157500, type=int, help="The global iteration of optimal checkpoint.")


    parser.add_argument("--max_num_utts", default="140", type=int, help= "max number of utterances")
    parser.add_argument("--early_stop", default="-1", type=float, help= "max number of utterances")
    # parser.add_argument("--early_stop", default="-1", type=float, help= "max number of utterances")


    parser.add_argument('--logging_steps', type=int, default=100, help="Log every X updates steps.")
    parser.add_argument('--validating_steps', type=int, default = 200, help= "Validate every X updates steps.")
    # parser.add_argument('--validating_steps', type=int, default = 1, help= "Validate every X updates steps.")
